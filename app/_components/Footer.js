  ...
  return (
    <footer className='my-4'>
      <div className="mx-auto px-4 pb-10 overflow-hidden">
        <nav className="flex flex-col gap-8 md:gap-0 md:flex-row md:justify-evenly items-center" aria-label="Footer">
          ...
          <div>
            {navigation.main.map((item) => (
              <div key={item.name} className="px-5 py-2 text-center md:text-left">
                <Link href={item.link} className="text-sm tracking-[1px] text-white hover:text-white/60 cursor-pointer font-satoshi font-normal">
                  {item.name}
                </Link>
              </div>
            ))}
        ...
        <p className="mt-8 text-center text-base text-white/60 font-normal font-chillax">&copy; 2025 Built by Code In Pixels</p>
      </div>
    </footer>
  )
}
